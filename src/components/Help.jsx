...
export default function HelpSection() {
  return (
    <div className="container-fluid mt-5" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
      <h2 style={{ color: 'blue' }}>Agent Dashboard Help</h2>
      ...
      <div className="d-flex flex-column my-4">
        {/* Overview of Agent Dashboard */}
        <div className="my-3">
          <h3 style={{ color: 'blue' }}>1. Overview of Agent Dashboard</h3>
          <p>
        ...
        <div className="my-3">
          ...
          <p>
            The User Conversations section shows the communication history between the Agent and the users for a specific ticket.
          </p>

          <p><strong>a. What Can You Do in the User Conversations Section?</strong></p>
          <ul>
            <li><strong>View User Conversations:</strong> You can see the full conversation history between the Agent and the user for a given ticket. The chat is displayed in a clear, conversational format, showing which messages were sent by the user and which were sent by the Agent.</li>
          ...
          <ul>
            ...
            <li><strong>Messages Displayed in Chat Format:</strong> The conversation is displayed in a chat format. Each message is attributed to either the user or the Agent, allowing for easy tracking of the conversation flow. Messages from the chatbot are styled differently for clear distinction.</li>
